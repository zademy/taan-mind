...
- [Conceptos](./concepts/) — vocabulario del dominio.
- [Flujos](./flows/) — procesos paso a paso.
- [Guías](./guides/) — cómo empezar, desarrollar cambios y desplegar.
- [Módulos](./modules/) — un doc por módulo o componente.

...
# SQLite con Drizzle ORM y migraciones generadas
...
- Las sesiones de [autenticación](./decision-autenticacion.md) y el [modelo de datos](../concepts/modelo-de-datos.md) comparten esta base.

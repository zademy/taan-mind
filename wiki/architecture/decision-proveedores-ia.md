...
# Proveedores de IA multi-proveedor con Vercel AI SDK
...
- El [modelo de enriquecimiento](../concepts/registro-de-documento.md) es un ajuste global de la app porque el procesamiento en fondo no corre en sesión de usuario.
